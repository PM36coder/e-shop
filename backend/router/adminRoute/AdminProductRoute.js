...
import { createAdminProduct,deleteProduct ,updateProduct} from '../../controllers/product/productController.js'
...
router.put('/update-product/:id', authMiddleware,adminMiddleware,upload.array('files',10) ,updateProduct)
